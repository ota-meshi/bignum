...
- <span class="minified-size"> 7.1 KB <!-- 7272 bytes --> minified ([bignumber.js]: 18.2 KB) </span>.
- <span class="minified-and-gzipped-size"> 3.0 KB minified and gzipped ([bignumber.js]: 8.1 KB) </span>.
...
It supports four arithmetic APIs and a basic API, which can be reduced to just <span class="bignum-basic-size"> 3.8 KB <!-- 3881 bytes --> with tree shaking and minification (minified and gzipped: 1.6 KB) </span>.\
